...
const BroucherPage = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 py-20
      ...
      {/* Glass card */}
      <div className="relative z-10 max-w-4xl w-full backdrop-blur-xl bg-white/40 border border-white/60
        rounded-2xl shadow-xl p-10 text-center flex flex-col items-center">

        <h1 className="text-3xl font-bold text-sky-700">Preview Our Brochure</h1>
        ...
        {/* Download button */}
        <a
          href="/Dholera-Brochure-HSC-A4-size-1.pdf"
          download
